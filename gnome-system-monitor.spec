...
Version  : 48.0
Release  : 29
URL      : https://download.gnome.org/sources/gnome-system-monitor/48/gnome-system-monitor-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-system-monitor/48/gnome-system-monitor-48.0.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-48.0
cd %{_builddir}/gnome-system-monitor-48.0
pushd ..
cp -a gnome-system-monitor-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742588538
...
/usr/share/metainfo/org.gnome.SystemMonitor.metainfo.xml
