...
Version  : 3.36.0
Release  : 13
URL      : https://download.gnome.org/sources/gnome-system-monitor/3.36/gnome-system-monitor-3.36.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-system-monitor/3.36/gnome-system-monitor-3.36.0.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-3.36.0
cd %{_builddir}/gnome-system-monitor-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585771175
...
cp %{_builddir}/gnome-system-monitor-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-system-monitor/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
