...
Version  : 3.26.0
Release  : 1
URL      : https://download.gnome.org/sources/gnome-system-monitor/3.26/gnome-system-monitor-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-system-monitor/3.26/gnome-system-monitor-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1518023145
...
%files data
%defattr(-,root,root,-)
/usr/share/appdata/gnome-system-monitor.appdata.xml
