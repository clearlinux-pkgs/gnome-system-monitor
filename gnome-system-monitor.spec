...
Version  : 46.0
Release  : 26
URL      : https://download.gnome.org/sources/gnome-system-monitor/46/gnome-system-monitor-46.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-system-monitor/46/gnome-system-monitor-46.0.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-46.0
cd %{_builddir}/gnome-system-monitor-46.0
pushd ..
cp -a gnome-system-monitor-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710950112
