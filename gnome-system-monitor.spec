...
Source0  : https://download.gnome.org/sources/gnome-system-monitor/40/gnome-system-monitor-40.0.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-40.0
cd %{_builddir}/gnome-system-monitor-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619115089
...
cp %{_builddir}/gnome-system-monitor-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-system-monitor/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
