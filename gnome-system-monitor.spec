...
Source0  : https://download.gnome.org/sources/gnome-system-monitor/48/gnome-system-monitor-48.1.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-48.1
cd %{_builddir}/gnome-system-monitor-48.1
pushd ..
cp -a gnome-system-monitor-48.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744646609
