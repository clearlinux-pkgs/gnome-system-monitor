...
Source0  : https://download.gnome.org/sources/gnome-system-monitor/3.28/gnome-system-monitor-3.28.1.tar.xz
...
%prep
%setup -q -n gnome-system-monitor-3.28.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1523304728
