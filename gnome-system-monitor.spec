...
%prep
%setup -q -n gnome-system-monitor-3.38.0
cd %{_builddir}/gnome-system-monitor-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600278928
...
cp %{_builddir}/gnome-system-monitor-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-system-monitor/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
